...
import org.mitre.openid.connect.web.*;
...
public abstract class ApiResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public ApiResourceServerConfig(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
    ...
    public static class WhitelistEndpointConfiguration extends ApiResourceServerConfig {
        ...
        public WhitelistEndpointConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
    ...
    public static class ApprovedSiteEndpointConfiguration extends ApiResourceServerConfig {
        ...
        public ApprovedSiteEndpointConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
    ...
    public static class BlacklistEndpointConfiguration extends ApiResourceServerConfig {
        ...
        public BlacklistEndpointConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
    ...
    public static class ClientEndpointConfiguration extends ApiResourceServerConfig {
        ...
        public ClientEndpointConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
    ...
    public static class DataEndpointConfiguration extends ApiResourceServerConfig {
        ...
        public DataEndpointConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
    ...
    public static class StatsEndpointConfiguration extends ApiResourceServerConfig {
        ...
        public StatsEndpointConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
    ...
    public static class TokenAPIConfiguration extends ApiResourceServerConfig {
        ...
        public TokenAPIConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
    ...
    public static class ScopeAPIConfiguration extends ApiResourceServerConfig {
        ...
        public ScopeAPIConfiguration(OAuth2AuthenticationEntryPoint authenticationEntryPoint) {
            super(authenticationEntryPoint);
        }
