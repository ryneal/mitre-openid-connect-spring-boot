...
public class CryptoConfig {
    ...
    public JWKSetKeyStore defaultKeyStore(@Value("${openid.connect.crypto.keystore.path}") final Resource location) {
    ...
    public JWTSigningAndValidationService defaultJwtSigningAndValidationService(final JWKSetKeyStore keystore,
                                                                                @Value("${openid.connect.crypto.signing.defaultSignerKeyId}") final String defaultSignerKeyId, @Value("${openid.connect.crypto.signing.defaultSigningAlgorithmName}") final String defaultSigningAlgorithmName) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public JWTEncryptionAndDecryptionService defaultJwtEncryptionAndDecryptionService(final JWKSetKeyStore keystore,
                                                                                      @Value("${openid.connect.crypto.encrypt.defaultAlgorithm}") final JWEAlgorithm defaultAlgorithm, @Value("${openid.connect.crypto.encrypt.defaultDecryptionKeyId}") final String defaultDecryptionKeyId, @Value("${openid.connect.crypto.encrypt.defaultEncryptionKeyId}") final String defaultEncryptionKeyId) throws NoSuchAlgorithmException, InvalidKeySpecException, JOSEException {
    ...
    public PasswordEncoder clientBCryptPasswordEncoder(@Qualifier("clientPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
    ...
    public PasswordEncoder userBCryptPasswordEncoder(@Qualifier("userPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
        final BCryptPasswordEncoderConfig bcryptConfig = passwordEncoderConfig.getBcrypt();
    ...
    public PasswordEncoder clientSCryptPasswordEncoder(@Qualifier("clientPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
    ...
    public PasswordEncoder userSCryptPasswordEncoder(@Qualifier("userPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
        final SCryptPasswordEncoderConfig scryptConfig = passwordEncoderConfig.getSCrypt();
    ...
    public PasswordEncoder clientStandardPasswordEncoder(@Qualifier("clientPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
    ...
    public PasswordEncoder userStandardPasswordEncoder(@Qualifier("userPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
        final StandardPasswordEncoderConfig standardConfig = passwordEncoderConfig.getStandard();
    ...
    public PasswordEncoder clientPbkdf2PasswordEncoder(@Qualifier("clientPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
    ...
    public PasswordEncoder userPbkdf2PasswordEncoder(@Qualifier("userPasswordEncoders") final PasswordEncoderTypeConfig passwordEncoderConfig) {
        final Pbkdf2PasswordEncoderConfig pbkdf2Config = passwordEncoderConfig.getPbkdf2();
    ...
    public static class PasswordEncoderTypeConfig {
        ...
        BCryptPasswordEncoderConfig getBcrypt() {
            return bcrypt;
        }

        SCryptPasswordEncoderConfig getSCrypt() {
            return scrypt;
        }

        StandardPasswordEncoderConfig getStandard() {
            return standard;
        }

        Pbkdf2PasswordEncoderConfig getPbkdf2() {
            return pbkdf2;
        }
