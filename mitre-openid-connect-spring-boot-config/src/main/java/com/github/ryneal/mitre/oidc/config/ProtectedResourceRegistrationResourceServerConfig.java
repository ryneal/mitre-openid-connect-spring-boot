...
public class ProtectedResourceRegistrationResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    private static final String PATTERN = "/" + org.mitre.openid.connect.web.ProtectedResourceRegistrationEndpoint.URL + "/**";

    private final Filter corsFilter;

    private final OAuth2AuthenticationEntryPoint authenticationEntryPoint;

    public ProtectedResourceRegistrationResourceServerConfig(@Qualifier("corsFilter") Filter corsFilter,
