package com.github.ryneal.mitre.oidc.config.ui;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public JsonMessageSource messageSource(@Value("classpath:/static/resources/js/locale/") final Resource baseDirectory, @Value("true") final Boolean useCodeAsDefaultMessage) {
